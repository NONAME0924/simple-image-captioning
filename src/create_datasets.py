...
class Create_datasets:
    def __init__(self,excel_name=None,csv_name=None,datasets_name=None,lang=None):
        self.datasets_name = datasets_name or 'vizwiz'
        self.excel_name = excel_name or 'default.xlsx'
        self.csv_name = csv_name or 'default.csv'
